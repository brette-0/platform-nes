...
// The four Metatiles_* reads below are RAM mirrors now (see metatiles.hpp's
// LoadMetatilePlanes) and CoinVramPush only touches the RAM CoinVram queue,
// so this needs no window-2 switch.
